module FreightQuote #:nodoc:
  class Origin #:nodoc:
    # == Description
    # This origin object can be used as a stand alone object. It acts just like an ActiveRecord object
    ...
    def validate
      errors.add :loading_dock, "is not true or false" unless [true,false].include?(loading_dock)
